 ...
 */
public class draw_continue_lines extends View {

    public draw_continue_lines(Context context) {
        super(context);
    }
    int length;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 1; i < list_of_points.size(); i++) {
               ...
               canvas.drawLine(list_of_points.get(i - 1).getX(), list_of_points.get(i - 1).getY(), list_of_points.get(i).getX(), list_of_points.get(i).getY(), list_of_Paint.get((i-1)/2));
